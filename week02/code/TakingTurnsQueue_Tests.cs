...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Dequeue returned the last element instead of the first.
    ...
    // Defect(s) Found: Incorrect dequeue order 
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: Turns are not decremented for those with 0 turns
    ...
    // Defect(s) Found: No exception was thrown when attempting to get a person from the empty queue
